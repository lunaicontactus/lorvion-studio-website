...
export const PROJECTS: readonly ProjectConfig[] = [
  ...
  },
  {
    id: 'lumiora',
    title: 'LUMIORA',
    tagline: 'Classical music is the physics of the world.',
    taglineKo: '클래식이 배경음악이 아니라, 세계의 물리법칙이 되는 곳.',
    kind: 'Stylized 3D Musical Narrative Adventure',
    ...
    world: 'lumiora',
    hero: { name: 'aquarium-concept', w: 1600, h: 900, caption: 'Aquarium · 컨셉 아트' },
    about: [
